...
(function ($) {
  ...
  var barcode = {
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      var bar0 = "<div style=\"display: inline-block; font-size: 0px; background-color: " + settings.bgColor + "; height: " + mh + "px; width: &Wpx\"></div>";    
      var bar1 = "<div style=\"display: inline-block; font-size: 0px; width:0; border-left: &Wpx solid " + settings.color + "; height: " + mh + "px;\"></div>";
